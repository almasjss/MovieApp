...
import com.almasjss.TestTask.dto.LoginDTO;
import com.almasjss.TestTask.entity.User;
import com.almasjss.TestTask.helpers.TokenHelper;
import com.almasjss.TestTask.requests.LoginRequest;
import com.almasjss.TestTask.service.UserService;
...
//регистрации
    ...
    public ResponseEntity register(@RequestBody User user) {
        ...
        //с проверкой на соотв-е паролей и наличия логина в списке зарегестрированых
...
//авторизации
    @PostMapping("/auth")
    public ResponseEntity auth(@RequestBody LoginDTO loginDto, HttpServletRequest request) {
        if (!userService.getUsers().containsKey(loginDto.getUsername()) ||
                !loginDto.getPassword().equals
                        (userService.getUser(loginDto.getUsername()).getPassword())) {
